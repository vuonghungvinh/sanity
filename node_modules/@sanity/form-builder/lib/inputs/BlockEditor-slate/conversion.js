...
function textSpanToSlateRange(input, index) {
  ...
  if (input.marks) {
    output.marks = input.marks.map(function (tag) {
      return {
        type: tag,
        data: {}
      };
...
function sanityBlockArrayToSlateDocument(sanityBlockText) {
  var raw = sanityBlockArrayToSlateRawState(sanityBlockText);
...
function sanityMarksToSlate(tags) {
  return new _immutable.Set(tags.map(function (tag) {
