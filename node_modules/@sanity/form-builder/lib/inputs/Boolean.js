...
var BooleanInput = function (_React$Component) {
  ...
  function BooleanInput() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = BooleanInput.__proto__ || Object.getPrototypeOf(BooleanInput)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (event) {
      _this.props.onChange(_PatchEvent2.default.from((0, _PatchEvent.set)(event.target.checked)));
  ...
  _createClass(BooleanInput, [{
    ...
    value: function render() {
      var _props = this.props,
          value = _props.value,
          type = _props.type,
          rest = _objectWithoutProperties(_props, ['value', 'type']);
