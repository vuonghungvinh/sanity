...
var UrlInput = function (_React$PureComponent) {
  _inherits(UrlInput, _React$PureComponent);
  ...
  function UrlInput() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = UrlInput.__proto__ || Object.getPrototypeOf(UrlInput)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (event) {
