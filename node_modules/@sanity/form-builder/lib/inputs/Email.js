...
var EmailInput = function (_React$PureComponent) {
  _inherits(EmailInput, _React$PureComponent);
  ...
  function EmailInput() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EmailInput.__proto__ || Object.getPrototypeOf(EmailInput)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (event) {
