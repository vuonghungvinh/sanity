"main";let postcss;_086‍.w('postcss',[["default",function(v){postcss=v}]]);let valueParser;_086‍.w('postcss-value-parser',[["default",function(v){valueParser=v}]]);let flatMap;_086‍.w('lodash',[["flatMap",function(v){flatMap=v}]]);
...
_086‍.d(postcss.plugin('postcss-font-family-system-ui', () => {
  return (root) => {
    root.walk(transform())
  }
}));
